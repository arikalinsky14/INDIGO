...
SCRIPT = ROOT / "src" / "compile_incorrect_datasets_batch.py"  # path to your batch script
STATE = ROOT / "incorrect_batches_state.json"                  # stores batch_ids & metadata

# Default model for Batch (override via CLI in submit-grid if you want)
DEFAULT_MODEL = "gpt-4o-mini-2024-07-18"

# ---------- PARAMS: EDIT THESE ----------
LAYERS = [4,6,8]            # e.g., [4, 6, 8]
ANGLES = [0]            # e.g., [0, 30, 60]
SEEDS  = [42, 84, 126, 168, 210, 252] #list(range(42, 4201, 200))  # add more as you like
