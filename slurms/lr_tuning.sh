...
echo "============================================================================"
echo "INDIGO LR FINDER - Job ${SLURM_JOB_ID}"
echo "============================================================================"
echo "PWD:      $(pwd)"
echo "Node:     $(hostname)"
...
#    sbatch slurms/lr_tuning.sh --epochs 4
#
# 2. Submit parallel jobs for scaling study:
#    for ep in 4 6 8 12; do
#      sbatch slurms/lr_tuning.sh --epochs $ep
#    done
#
# 3. Custom LR range:
#    sbatch slurms/lr_tuning.sh --epochs 8 --lr-min 5e-5 --lr-max 5e-3
#
# 4. More LR values for finer search:
#    sbatch slurms/lr_tuning.sh --epochs 6 --n-lrs 15
#
