...
# ΔE₀₀ lives in src.color_utils; re-exported at module scope here because
# other tooling (scripts/plot_de_curve.py, the de_curve wrappers) imports
# `ciede2000` / `lab_diff_ciede2000` from this module.
